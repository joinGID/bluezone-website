      ...
      <div className="absolute bottom-10 left-0 right-0 z-10 flex justify-center gap-3">
        {images.map((_, index) => (
          <button
            ...
            className={`relative h-1.5 rounded-full overflow-hidden transition-all duration-300 ${index === currentIndex ? "w-12 bg-white/30" : "w-1.5 bg-white/50 hover:bg-white/80"
              }`}
