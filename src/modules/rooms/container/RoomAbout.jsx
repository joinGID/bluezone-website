        ...
        <div className="text-[#153f41] space-y-10">
          <div className="flex items-center md:space-x-10 space-x-2 md:text-lg text-xs font-medium ">
            <div className="flex items-center md:space-x-5 space-x-2">
              ...
              <span>{roomData.roomSize}</span>
            </div>
            <div className="flex items-center md:space-x-5 space-x-2">
              <span className="">
                <Bed size={20} />
              </span>
              <span className="">{roomData.bedName}</span>
            </div>
            <div className="flex items-center md:space-x-5 space-x-2">
              <span className="">
          ...
          <div className="border-b-2 border-gray-300 "></div>
            ...
            <div>
              ...
              <p className="text-4xl font-medium">
                {roomData.amount} <span className="text-xl">/ {roomData.priceUnit}</span>
              </p>
            </div>
